...
class MemoryOnlySettingsPersistence implements SettingsPersistence {
  ...
  @override
  Future<void> saveAudioOn({required bool value}) async => audioOn = value;

  @override
  Future<void> saveMusicOn({required bool value}) async => musicOn = value;

  @override
  Future<void> savePlayerName(String value) async => playerName = value;

  @override
  Future<void> saveSoundsOn({required bool value}) async => soundsOn = value;
}
