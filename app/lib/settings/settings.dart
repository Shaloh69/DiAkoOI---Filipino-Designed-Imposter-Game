...
import 'package:diakooi/settings/persistence/local_storage_settings_persistence.dart';
import 'package:diakooi/settings/persistence/settings_persistence.dart';
...
class SettingsController {
  ...
  SettingsController({SettingsPersistence? store})
    ...
    unawaited(_loadStateFromPersistence());
  }
  ...
  void setPlayerName(String name) {
    ...
    unawaited(_store.savePlayerName(playerName.value));
  }

  void toggleAudioOn() {
    audioOn.value = !audioOn.value;
    unawaited(_store.saveAudioOn(value: audioOn.value));
  }

  void toggleMusicOn() {
    musicOn.value = !musicOn.value;
    unawaited(_store.saveMusicOn(value: musicOn.value));
  }

  void toggleSoundsOn() {
    soundsOn.value = !soundsOn.value;
    unawaited(_store.saveSoundsOn(value: soundsOn.value));
  }
